...
begin
  ...
  edt_ean_tipo.Text := JSONData.FindPath('ean_tipo').AsString;
  ...
  edt_unid_abr.Text := JSONData.FindPath('unid_abr').AsString;
  edt_unid_desc.Text := JSONData.FindPath('unid_desc').AsString;
